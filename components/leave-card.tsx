...
const EarlyLeaveCard = () => {
		...
		return (
			<div className='p-6'>
				<div className='flex items-center justify-between'>
					<div>
						<p className='text-sm font-medium text-muted-foreground mb-1'>Tỷ lệ về sớm</p>
	...
	const currentRate = data?.early.current.rate || 0;
	const delta = data?.early.delta || 0;

	// For early leave, negative delta is good (shown in green - decrease in early leaves)
