														...
														<TableCell>
															<div className='flex items-center gap-2'>
																...
																<div className='flex items-center space-x-2'>
																	<Switch
																		id={`auto-mode-${gate.id}`}
																		checked={gate.mode === 'Tự động'}
																	/>
																</div>
															</div>
														</TableCell>
							...
							<div className='grid grid-cols-1 md:grid-cols-2 gap-6 mt-6'>
								<Card>
									<CardHeader>
										...
										<CardDescription>
											Thống kê hoạt động của các cổng trong ngày hôm nay
										</CardDescription>
									</CardHeader>
									<CardContent>
										...
										<div className='space-y-2'>
											...
											<div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
												...
												<div className='p-4 border rounded-lg'>
													...
													<p className='text-sm text-muted-foreground'>
														Tự động mở cổng khi xác thực vân tay thành công
													</p>
												</div>
												<div className='p-4 border rounded-lg'>
													<div className='flex items-center justify-between mb-2'>
													...
													<p className='text-sm text-muted-foreground'>
														Tự động mở cổng khi quẹt thẻ từ hợp lệ
													</p>
												</div>
												<div className='p-4 border rounded-lg'>
													<div className='flex items-center justify-between mb-2'>
										...
										<div className='space-y-2'>
											...
											<div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
												...
												<div className='p-4 border rounded-lg'>
													...
													<p className='text-sm text-muted-foreground'>
														Gửi cảnh báo khi có sự cố hoặc truy cập trái phép
													</p>
												</div>
											</div>
										</div>
